...
class MBConvBlock(nn.Module):
    ...
    def forward(self, inputs, drop_connect_rate=None, drop_connect_enable=False):
        """
        ...
        if self.id_skip and self._block_args.stride == 1 and input_filters == output_filters:
            if drop_connect_rate:
                x = drop_connect(x, p=drop_connect_rate,
                                 training=self.training or drop_connect_enable)
...
class EfficientNet(nn.Module):
    ...
    def __init__(self, blocks_args=None, global_params=None):
        ...
        self.drop_connect_enable = False
    ...
    def extract_features(self, inputs):
        ...
        for idx, block in enumerate(self._blocks):
            ...
            x = block(x, drop_connect_rate=drop_connect_rate, drop_connect_enable=self.drop_connect_enable)
